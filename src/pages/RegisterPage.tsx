...
import { Car, Mail, Lock, User, Phone, Eye, EyeOff, AlertCircle, CheckCircle, Wrench, Building } from 'lucide-react';
...
const RegisterPage: React.FC = () => {
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: 'customer' as 'customer' | 'garage_owner',
    agreeToTerms: false,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Garage owner specific validation
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      name="garageName"
                      type="text"
                      required={formData.role === 'garage_owner'}
            ...
            <div className="flex items-start">
              ...
              <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-gray-700">
                ...
                {formData.role === 'garage_owner' && (
                  <>
                    {' '}and the{' '}
                    <Link to="/garage-terms" className="text-primary hover:text-primary-dark">
